            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Furniture Supplier Update Page </h4><br><br>

                        <form method="post" action="{{ route('furnitureSupplier.update') }}" id="myForm">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Supplier Mobile
                                    No.</label>
                                <div class="form-group col-sm-10">
                                    <input name="mobileNo" class="form-control" value="{{ $supplier->mobileNo }}"
                                        type="number" id="mobileNum">
                                </div>
                            </div>
                            <!-- end row -->
